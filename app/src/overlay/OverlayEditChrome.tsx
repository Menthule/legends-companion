 ...
 *  hide when you lock (Settings → "Arrange overlays" off applies it).
 *  Dragging (from the tag or the pill body) is handled by OverlayShell's
 *  uniform mousedown → startDragging; the tag just bubbles into it. */
